...
export const TaipeiBuilding = {
	...
	"source-layer": "tp_building_height84-018drq", // [Add 3D Taipei Buildings Model (Optional)](https://tuic.gov.taipei/documentation/front-end/project-setup#add-3d-taipei-buildings-model-(optional))
	type: "fill-extrusion",
	minzoom: 14,
	paint: {
